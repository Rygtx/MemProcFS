...
typedef enum tdSTATISTICS_ID {
    ...
    STATISTICS_ID_VMMDLL_MemVirtualQuery,
    ...
    STATISTICS_ID_VMMDLL_WinReg_QueryNameOriginalU,
    STATISTICS_ID_VMMDLL_WinReg_QueryNameOriginalW,
...
static LPCSTR STATISTICS_ID_STR[STATISTICS_ID_MAX] = {
    ...
    [STATISTICS_ID_VMMDLL_MemVirtualQuery]          = "VMMDLL_MemVirtualQuery",
    ...
    [STATISTICS_ID_VMMDLL_WinReg_QueryNameOriginalU] = "VMMDLL_WinReg_QueryNameOriginalU",
    [STATISTICS_ID_VMMDLL_WinReg_QueryNameOriginalW] = "VMMDLL_WinReg_QueryNameOriginalW",
